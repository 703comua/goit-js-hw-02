...
console.log(">>> Task-4.js <<<"); // "Curabitur ligula..."
...
function getShippingCost(country)
{
	...
	return deliveryIsPossible ? `"Shipping to ${country} will cost ${price} credits"` : "Sorry, there is no delivery to your country";
